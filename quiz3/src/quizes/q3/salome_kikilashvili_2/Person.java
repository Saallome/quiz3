package quizes.q3.salome_kikilashvili_2;
...
public class Person {
    ...
    public static void main(String[] args) {
        ...
        HotelManager hotelManager = new HotelManager(100);
        Person person1 = new Person();
        person1.setName("John");
        person1.setSurname("Doe");

        // Check-in
        hotelManager.checkIn(person1, String.valueOf(3));

        // Check-out
        hotelManager.checkOut(String.valueOf(3));
        ...
        for (Person person : persons) {
            if (person.getName().equals("Salome") && person.getSurname().equals("Kikilashvili")) {
                targetPerson = person;
                break;
            }
        }
